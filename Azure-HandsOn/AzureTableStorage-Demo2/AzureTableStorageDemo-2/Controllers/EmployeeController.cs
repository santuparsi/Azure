...
namespace AzureTableStorageDemo.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public IEnumerable<EmployeeEntity> GetByName(string name)
        {

            var condition = TableQuery.GenerateFilterCondition("PartitionKey", QueryComparisons.Equal, name);
        ...
        public IEnumerable<EmployeeEntity> Post([FromBody]EmployeeEntity emp)
        {
            ...
            table.CreateIfNotExists(); //create Employee table in Table storage
